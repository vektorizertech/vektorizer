      ...
      <section className="py-20 hero-gradient">
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <p
              className="max-w-3xl mx-auto mb-8 text-xl md:text-2xl text-muted-foreground"
              data-aos="fade-up"
              data-aos-delay="200"
            >
        ...
        <div className="container px-4">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {PROJECTS.map((project, index) => (
              <Card
                key={index}
                className="overflow-hidden transition-all duration-300 card-gradient hover:scale-[1.02] group p-6"
          ...
          <div className="max-w-3xl mx-auto text-center" data-aos="fade-up">
            ...
            >
              <Button
                asChild
                size="lg"
                className="px-8 py-6 text-lg dark:text-white"
              >
